...
class Game_GUI {
    ...
    Game_Component atmosphereComponent; //Two GameComponents: one for the background images, buttons, and the overall atmosphere.
    Game_Component cardComponent; //Other for the cards printing out.
    ...
    public Game_GUI(JFrame f) {//with this constructor, we initialize the instant fields accordingly. This constructor gets a JFrame as a parameter.
        ...
        atmosphereComponent = new Game_Component(Deck,dealerHand, playerHand1,playerHand2,playerHand3);
        frame = f;
        faceDown = true;
    }
    ...
    public void formGame(Card[] deck,Card []player1hand, Card []player2hand,Card []player3hand,Card []dealerhand) {
        ...
        atmosphereComponent = new Game_Component(Deck,dealerHand, playerHand1,playerHand2,playerHand3); //we initialize the GameComponent that will be the overall atmosphere of our game.
    ...
    public void updateDealerHand(Card c, Card[]deck){
        ...
        Game_Component.dealers_turn=true;
        Deck.clear();
    ...
    public void startGame(Card[] deck,Card []player1hand, Card []player2hand,Card []player3hand,Card []dealerhand) { //this method starts the game: the cards are drawn and are printed out.
        ...
        cardComponent = new Game_Component(Deck,dealerHand, playerHand1,playerHand2,playerHand3); //we initialize our component which accepts two card arraylists.
