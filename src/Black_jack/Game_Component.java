...
class Game_Component extends JComponent {//this class will implement the MouseListener because we will check if the user clicked a certain coordinate on the component.
    ...
    public Game_Component(ArrayList<Card_GUI>deck,ArrayList<Card_GUI> dH, ArrayList<Card_GUI> pH1, ArrayList<Card_GUI> pH2,ArrayList<Card_GUI> pH3) { //this will be the constructor for this class which will accept two hands as a parameter.
